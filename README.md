...
Login, cadastro inicial opcional, painel autenticado, lojas, criação de produtos com preço, edição de nome/status com proteção contra conflitos, busca, filtro e auditoria. Consulte [estado da implementação](IMPLEMENTATION_STATUS.md) para evidências, limites e continuidade entre Codex e v0.
